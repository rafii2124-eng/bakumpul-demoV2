      ...
      <header className="bg-indigo-900 text-white border-b border-indigo-800 px-4 sm:px-8 py-3 flex flex-wrap items-center justify-between shadow-lg z-20">
        ...
        <div className="flex items-center space-x-3 sm:space-x-5 text-xs font-bold text-indigo-100">
          ...
          <button
            ...
            className="hover:text-white flex items-center space-x-1.5 transition bg-white/10 px-2.5 py-1.5 rounded-lg border border-white/15 cursor-pointer"
          >
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto p-3 sm:p-6 lg:p-8 flex items-center justify-center">
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-0 lg:gap-6 bg-white rounded-3xl shadow-2xl overflow-hidden border border-indigo-900/30">
          ...
          <div className="lg:col-span-5 bg-white p-6 sm:p-8 flex flex-col justify-center">
            ...
            {/* PETUNJUK REGISTRASI */}
            <div className="mt-4 rounded-xl border border-dashed border-indigo-400 bg-indigo-50/70 p-3 space-y-2">
              <p className="text-[11px] font-black text-indigo-900 uppercase tracking-wider flex items-center space-x-1.5">
                <FileText className="w-3.5 h-3.5 text-indigo-600" />
                <span>Petunjuk Registrasi Akun</span>
              </p>
              <ol className="space-y-1.5 text-[11px] text-slate-600 font-medium">
                <li className="flex items-start space-x-2">
                  <span className="w-5 h-5 shrink-0 bg-indigo-900 text-white text-[9px] font-black rounded-full flex items-center justify-center">1</span>
                  <span>Klik tombol <strong>Registrasi Akun</strong> di menu atas atau tautan <strong>&ldquo;Belum Memiliki Akun? Registrasi&rdquo;</strong>.</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="w-5 h-5 shrink-0 bg-indigo-900 text-white text-[9px] font-black rounded-full flex items-center justify-center">2</span>
                  <span>Isi <strong>NPSN</strong> (Username), <strong>Nama Sekolah</strong>, <strong>Nama Guru</strong>, dan <strong>NIP/NIK</strong> (Password).</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="w-5 h-5 shrink-0 bg-indigo-900 text-white text-[9px] font-black rounded-full flex items-center justify-center">3</span>
                  <span>Klik <strong>Simpan &amp; Buat Akun</strong> — akun tersimpan di perangkat &amp; server.</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="w-5 h-5 shrink-0 bg-indigo-900 text-white text-[9px] font-black rounded-full flex items-center justify-center">4</span>
                  <span>Masuk dengan <strong>NPSN</strong> sebagai Username dan <strong>NIP/NIK</strong> sebagai Password.</span>
                </li>
              </ol>
              <button
                type="button"
                onClick={() => setShowRegisterModal(true)}
                className="w-full mt-1 bg-indigo-900 hover:bg-indigo-950 text-white font-bold text-[11px] py-2 rounded-lg transition cursor-pointer flex items-center justify-center space-x-1.5"
              >
                <UserPlus className="w-3.5 h-3.5 text-amber-300" />
